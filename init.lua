...
require("lazy").setup({
	...
	-- Treesitter ---------------
	{
		...
		build = ":TSUpdate",
		opts = {
			ensure_installed = { "bash", "c", "cpp", "lua", "python", "rust", "regex", "markdown", "markdown_inline" },
			auto_install = true,
		},
	},
	-- Telescope --------------
	...
	},
	{
		...
		config = function()
			...
			vim.lsp.enable({ "clangd", "rust_analyzer", "lua_ls", "pylsp", "ruff" })
		end,
	},
	{
		"hrsh7th/nvim-cmp",
...
require("which-key").add({
	...
	{ "<leader>et", "<cmd>Neotree filesystem reveal toggle left<cr>", desc = "Toggle" },
	...
	{ "<leader>m", "<cmd>Markview toggle<cr>", desc = "Markdown" },
})
